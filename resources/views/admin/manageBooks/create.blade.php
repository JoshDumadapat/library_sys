<div class=" mt-5 me-3 ms-3" style="height: 700px; overflow-y: auto; border-radius:12px;" id="add-book-form-card">
    <div class="  px-4 py-4">
        ...
        <form action="{{ route('managebooks.store') }}" method="POST">
            ...
            <div class="text-center mt-4">
                ...
                <button class="btn btn-view me-2" id="book-cancel-btn" style="font-size: 1.1rem;">Cancel</button>
            </div>
        </form>
    </div>
</div>
