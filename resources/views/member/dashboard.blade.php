                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full border border-gray-200 text-sm text-left">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="px-4 py-2 border">AD-211</td>
                                        <td class="px-4 py-2 border">Harry Potter 2</td>
                                        <td class="px-4 py-2 border">Luong Khoa</td>
                                        <td class="px-4 py-2 border">Suspense</td>
                                        <td class="px-4 py-2 border">AC-111</td>
                                        <td class="px-4 py-2 border">10</td>
                                        <td class="px-4 py-2 border">0</td>
                                        <td class="px-4 py-2 border">Available</td>
                                        <td class="px-4 py-2 border"><button class="btn btn-primary">View</button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
